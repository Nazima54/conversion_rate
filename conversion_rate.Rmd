...
* Predict conversion rate Come up with recommendations for the product team and the marketing team to improve conversion rate 

### Data Columns
* country : user country based on the IP address 
* age : user age. Self-reported at sign-in step 
* new_user : whether the user created the account during this session or had already an account and simply came back
* site source : marketing channel source 
...
```{r,include=TRUE,warning=FALSE,message=FALSE}
# Let's now build a model to predict conversion rate. Outcome is binary and you care about insightsto give product and marketing team some ideas. We will probably choose among thefollowing models:
